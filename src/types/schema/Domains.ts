import { EndsWith, Ip4Octet, IsEqual, NumericChar, NumericChar__ZeroToFive, NumericChar__ZeroToFour, StripAfter, Suggest } from "inferred-types";
import { FromSchemaTuple, SchemaCallback } from "./schema";
